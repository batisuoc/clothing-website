...
<body id="page-top">
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="<?= ADMIN_URL ?>index">Trang chủ</a>
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			<li class="nav-item active">
				<a class="nav-link" href="<?= ADMIN_URL ?>index">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<span>Quản lý Trang SP</span>
				</a>
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<h6 class="dropdown-header">Trang sản phẩm</h6>
			...
			<li class="nav-item">
				<a class="nav-link" href="<?= ADMIN_URL ?>product">
