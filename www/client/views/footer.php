					...
					<ul>
						<li>
							...
							<div class="contact-text">
								<p style="margin-top: 1px;"><span>235B Nguyen Van Cu Street,</span> <span>District 1. Ho Chi Minh City</span></p>
							</div>
						</li>
						<!-- <li>
						...
						<li>
							...
							<div class="contact-text">
								<p style="margin-top: 7px;"><span>+84 (098) 7657376</span></p>
							</div>
						</li>
					</ul>
				</div>
				...
				<div class="single-footer newslatter-area">
					...
					<div class="newslatter">
						...
						<div class="social-icon socile-icon-style-3 mt-40">
							...
							<ul>
								<li><a href="https://www.facebook.com/1mkstore/"><i class="zmdi zmdi-facebook"></i></a></li>
